...
public class MathUtilsTest {
  ...
  public void test_lgamma() {
    assertTrue(MathUtils.equals(MathUtils.lgamma(10), 12.801827, 3));
    assertTrue(MathUtils.equals(MathUtils.lgamma(100), 359.134205, 10));
    assertTrue(MathUtils.equals(MathUtils.lgamma(1000), 5905.220423, 10));
    assertTrue(MathUtils.equals(MathUtils.lgamma(10000), 82099.717496, 10));
    assertTrue(MathUtils.equals(MathUtils.lgamma(100000), 1051287.708974, 20));
  }
