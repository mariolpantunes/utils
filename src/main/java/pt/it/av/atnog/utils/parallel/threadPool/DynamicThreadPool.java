package pt.it.av.atnog.utils.parallel.threadPool;

import pt.it.av.atnog.utils.parallel.IdleWorker;
...
public class DynamicThreadPool implements ThreadPool, Runnable {
   ...
   * @param t
   */
  public DynamicThreadPool(final Task t) {
   ...
   * @param maxIdleTime
   */
  public DynamicThreadPool(final Task t, final long maxIdleTime) {
   ...
   * @param maxIdleTime
   */
  public DynamicThreadPool(final Task t, final int nWorkers, final long maxIdleTime) {
    this.t = t;
